...
export default function Year01() {
  return (
    <div className="page-container">
      ...
      <p className="text-desc" style={{ textAlign: 'center', color: 'var(--accent-red)', fontStyle: 'italic', marginBottom: '3rem', fontSize: '1.1rem' }}>
      ...
      <div className="modules-grid">
        ...
        <section className="module-section">
          <h2 className="brand-font" style={{ color: 'var(--text-main)', borderBottom: '1px solid var(--border-dark)', paddingBottom: '0.5rem' }}>Y1S1</h2>
          
          <div style={{ marginTop: '1.5rem' }}>
            <h3 className="text-title" style={{ marginBottom: '0.5rem' }}>Data Communication Networks (DCN)</h3>
          ...
          <div style={{ marginTop: '1.5rem' }}>
            <h3 className="text-title" style={{ marginBottom: '0.5rem' }}>Introduction to Programming (IP)</h3>
            <ul style={{ listStyleType: 'none', padding: 0, lineHeight: '2' }}>
        ...
        {/* ======================= SEMESTER 2 ======================= */}
        <section className="module-section">
          <h2 className="brand-font" style={{ color: 'var(--text-main)', borderBottom: '1px solid var(--border-dark)', paddingBottom: '0.5rem' }}>Y1S2</h2>
          ...
          <div style={{ marginTop: '1.5rem' }}>
            <h3 className="text-title" style={{ marginBottom: '0.5rem' }}>Technical Writing (TR)</h3>
            <ul style={{ listStyleType: 'none', padding: 0, lineHeight: '2' }}>
